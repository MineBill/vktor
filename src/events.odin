...
event_context_clear :: proc(ec: ^Event_Context) {
    clear(&ec.events)
    clear(&ec.characters)
}
...
setup_events :: proc(window: glfw.WindowHandle, event_context: ^Event_Context) {
    glfw.SetWindowUserPointer(window, event_context)
